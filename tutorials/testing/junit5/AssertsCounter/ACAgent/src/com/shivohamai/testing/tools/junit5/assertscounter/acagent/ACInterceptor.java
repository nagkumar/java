...
public final class ACInterceptor
{
    ...
    private static ACAgentCFG config;

    public static void setConfig(final ACAgentCFG aAgentConfig)
    {
	config = aAgentConfig;
    }
	...
	for (StackTraceElement ste : stackTrace)
	{
	    ...
	    if (className.equals(ACInterceptor.class.getName())
